            ...
            var t, i = "mCustomScrollbar",
                ...
                j = function() {
                    ...
                    if (!o.bindEvents) {
                        ...
                        D.call(this), W.call(this), s.advanced.autoScrollOnFocus && B.call(this), s.scrollButtons.enable && O.call(this), s.keyboard.enable && R.call(this), o.bindEvents = !0
                    }
                },
                _ = function() {
                    var t = e(this),
                ...
                P = function() {
                    ...
                    function o(e) {
                        if (J(e) && !d && !I(e)[2] && (e.stopImmediatePropagation(), (!C || S) && c)) {
                            ...
                            a || p ? (R || e.preventDefault(), S = 1) : (C = 1, T.addClass("mCS_touch_action")), R && e.preventDefault(), w = "yx" === j.axis ? [u - i, h - n] : "x" === j.axis ? [null, h - n] : [u - i, null], M[0].idleTimer = 250, k.overflowed[0] && l(w[0], z, o, "y", "all", !0), k.overflowed[1] && l(w[1], z, o, "x", D, !0)
                        }
                    }
                    ...
                    function a(e) {
                        if (J(e) && !d && !I(e)[2]) {
                            ...
                            if (!(v - g > 30)) {
                                ...
                                w[0] = u[0] > T ? w[0] : 0, w[1] = u[1] > T ? w[1] : 0, k.overflowed[0] && l(w[0], x[0], o, "y", D, !1), k.overflowed[1] && l(w[1], x[1], o, "x", D, !1)
                            }
                        }
                    }
...
mejs.version = "2.18.2", mejs.meIndex = 0, mejs.plugins = {
    ...
    function(e) {
        ...
        function t() {
            ...
            k || (t.appear(), t.on("appear", function(t, i) {
                for (var n = 0; n < i.length; n++) e(i[n]).addClass("animated")
            }), e.force_appear())
        }

        function i() {
            var t = e(".progress-bar", "#skills");
            k ? n(t) : (t.appear(), t.on("appear", function(e, t) {
                n(t)
            }), e.force_appear())
        }
        ...
        function o() {
            var t = e(".interests-list", "#interests"),
                i = e(".interests-list li span", "#interests");
            if (t.length > 0)
                for (var n = 0; n < i.length; n++) {
        ...
        function a() {
            ...
            t.length > 0 && (I = {
                ...
                createMonthHtml: function(e, t) {
                    var i = "",
                        ...
                        s = [];
                    r.empty().html(this.monthNames[t]), l.empty().html(e);
                    ...
                    for (var d = 0; 42 > d; d++) {
                        var c = "";
                        e == this.currentYear && t == this.currentMonth && d - o + 1 == this.currentDay && (c += "current-day"), w(s, d - o + 1) && (c += "busy-day"), d % 7 == 0 && (i += "<tr>"), i += o > d || d >= o + this.getDaysInMonth(e, t) ? '<td class="calendar-other-month"><span></span></td>' : '<td class="calendar-current-month"><span class="' + c + '">' + (d - o + 1) + "</span></td>", d % 7 == 6 && (i += "</tr>")
                    }
                    n.empty().append(i)
                },
                nextMonth: function() {
            ...
            }, I.active.year = I.currentYear, I.active.month = I.currentMonth, I.limitUp.year = I.currentYear + 1, I.limitUp.month = I.currentMonth, I.limitDown.year = I.currentYear, I.limitDown.month = I.currentMonth, I.busyDays = M, I.init(), t.on(j, ".calendar-prev", function() {
                I.prevMonth()
            }), t.on(j, ".calendar-next", function() {
                I.nextMonth()
            }))
        }
        ...
        function d() {
            var t = e(".nav a[href*=#]");
            t.on("click", function() {
                if (e(this).parents(".mobile-nav").length ? v() : e(this).parents(".nav-wrap").length && (t.parent().removeClass("active"), e(this).parent().addClass("active")), location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                    var i = e(this.hash),
                        n = this.hash.slice(1);
        ...
        function c() {
            var t = e(".header");
            e(window).width() > 767 && !k ? (E < _.outerHeight() && (E = _.outerHeight(), t.css("min-height", E + "px")), e(window).scrollTop() > _.outerHeight() ? _.addClass("head-sticky") : _.removeClass("head-sticky")) : (_.removeClass("head-sticky"), t.css("min-height", "0px"))
        }
        ...
        function g() {
            e("body").addClass("mobile-nav-opened"), m()
        }

        function v() {
            e("body").removeClass("mobile-nav-opened"), f()
        }

        function y() {
            e("body").addClass("sidebar-opened"), m()
        }

        function b() {
            e("body").removeClass("sidebar-opened"), f()
        }
        ...
        var k, j = null !== document.ontouchstart ? "click" : "touchstart",
            _ = e(".head-bar"),
            E = 0,
            I = new Object,
            M = [new Date(2015, 11, 3), new Date(2015, 11, 15), new Date(2015, 11, 19), new Date(2015, 11, 30), new Date(2015, 11, 31), new Date(2016, 0, 11), new Date(2016, 0, 12), new Date(2016, 0, 13), new Date(2016, 0, 14), new Date(2016, 1, 3), new Date(2016, 1, 15), new Date(2016, 1, 18), new Date(2016, 1, 29), new Date(2016, 2, 3), new Date(2016, 2, 15), new Date(2016, 2, 16), new Date(2016, 2, 18), new Date(2016, 2, 28), new Date(2016, 2, 29), new Date(2016, 2, 30)];
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (k = !0, e("html").addClass("mobile")) : (k = !1, e("html").addClass("desktop"));
        var P, F = e(window).width(),
            L = e(window).height();
        e(window).resize(function() {
            var t = function() {
                ...
                i = e(window).width(),
                n = e(window).height();
            (F != i || L != n) && (window.clearTimeout(P), P = window.setTimeout(t, 10)), F = i, L = n
        }), e(window).load(function() {
            t(), i(), o(), s(), a(), S(), T();
            var n = e(".ref-slider");
            n.length > 0 && n.bxSlider({
                auto: !0,
                pager: !1,
                controls: !0,
                adaptiveHeight: !0,
            ...
            if (m.length > 0)
                for (var f = 0; f < m.length; f++) {
                    var w = e(m[f]).closest(".post-media").find(".slider-prev"),
                        k = e(m[f]).closest(".post-media").find(".slider-next");
                    e(m[f]).bxSlider({
                        pager: !1,
                        controls: !0,
                        nextSelector: k,
            ...
            var E = e(".post-media audio");
            E.length > 0 && E.mediaelementplayer({
                loop: !1,
                audioHeight: 40,
                startVolume: .7
            });
            var I = e(".post-media video");
            I.length > 0 && I.mediaelementplayer({
                loop: !1,
            ...
            for (var M = e(".input-field input, .input-field textarea"), f = 0; f < M.length; f++) e(M[f]).val() ? e(M[f]).parent(".input-field").addClass("used") : e(M[f]).parent(".input-field").removeClass("used");
            M.on("blur", function() {
                e(this).val() ? e(this).parent().addClass("used") : e(this).parent().removeClass("used")
            }), M.on("focus", function() {
                e(this).parent().addClass("used")
            }), e(document).on(j, ".ripple", function(t) {
                C(e(this), t.pageX, t.pageY)
            }), e(document).on(j, ".ripple-centered", function() {
            ...
            if (P.length > 0) {
                ...
                if (L.length > 0) {
                    var A = L.find("button"),
                        z = e(".filter-btn-group button:first-child");
                    r(F, z), z.addClass("active"), A.on("click", function() {
                        A.removeClass("active"), e(this).addClass("active"), e(".grid-box").addClass("animated"), r(F, e(this))
                    })
                }
                var D = 0,
                    B = 0,
                    ...
                    O = e(".grid-more"),
                    R = O.find(".btn"),
                    H = O.find(".ajax-loader");
                R.on("click", function() {
                    e.ajax({
                        url: "ajax/portfolio.html",
                        dataType: "html",
                        beforeSend: function() {
                            R.css("display", "none"), H.css("display", "inline-block")
                        },
                        success: function(t) {
                            if (D = e.grep(e.parseHTML(t), function(t, i) {
                                    return e(t).hasClass("grid-item")
                                }).length, D > B)
                                for (var i = 1; W >= i; i++) {
                                    var n = e(t).filter(".grid-item:eq(" + B + ")");
                                    P.append(n).isotope("appended", n), B++
                                }
                            B >= D && O.hide(), R.css("display", "inline-block"), H.css("display", "none")
                        }
                    })
                });
                var N;
                e(".portfolioFancybox").fancybox({
                    ...
                    afterShow: function() {
                        var t = e(this.element).attr("href"),
                            i = e("" + t).find("video");
                        i.length > 0 && new MediaElementPlayer(t + " video", {
                            loop: !1,
                            defaultVideoWidth: 723,
                            defaultVideoHeight: 405,
                            videoWidth: -1,
                    ...
                    beforeClose: function() {
                        navigator.userAgent.match(/msie [6-8]/i) && N.remove()
                    }
                })
            }
            l(), d(), e(".nav-wrap .nav").length > 0 && e(".nav-wrap .nav > ul > li > a").append("<span></span>"), _.length > 0 && (_.addClass("animated"), c(), e(window).scroll(function() {
                c()
            })), c(), e(document).on(j, ".btn-mobile", function() {
                e("body").hasClass("mobile-nav-opened") ? v() : g()
            }), e(".mobile-nav").length > 0 && e(".mobile-nav-inner").mCustomScrollbar({
                theme: "dark"
            }), e(document).on(j, ".btn-sidebar", function() {
                e("body").hasClass("sidebar-opened") ? b() : y()
            }), e(".sidebar-fixed").length > 0 && e(".widget-area").mCustomScrollbar({
                theme: "dark"
            }), e(document).on(j, "#overlay", function() {
                e("body").hasClass("mobile-nav-opened") && v(), e("body").hasClass("sidebar-opened") && b()
            }), e("#map").length > 0 && p();
            var V = e(".btn-scroll-top");
            e(window).scroll(function() {
                e(this).scrollTop() > 100 ? V.fadeIn() : V.fadeOut()
            }), V.on("click", function() {
                return e("html, body").animate({
                    scrollTop: 0
                }, 800), !1
            }), e(".contact-submit").on("click", function(t) {
                C(e(this).parent(), t.pageX, t.pageY);
